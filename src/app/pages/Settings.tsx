...
const inputCls = "flex h-9 w-full rounded-md border border-border bg-muted/50 px-3 py-1 text-sm text-muted-foreground cursor-not-allowed";
        ...
        <div className="bg-card rounded-xl border shadow-sm overflow-hidden">
          ...
          <div className="px-6 py-5 space-y-4">
            ...
            <div>
              ...
              <input readOnly value={user?.id ?? ''} className={`${inputCls} font-mono text-xs`} />
            </div>
          </div>
        </div>
